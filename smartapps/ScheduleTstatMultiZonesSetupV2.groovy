...
def zonesSetup(params) {
	...
	def indiceZone=params.number.intValue()
...
def scheduleSetup(params) {
	def indiceSchedule=params.number.intValue()
	log.debug "sheduleSetup> indiceSchedule=${indiceSchedule}"
